...
import { generateDayworkPdf, generateJobSheetPdf, generateManagerJobListPdf, generateTimesheetPdf } from '@/lib/pdfReport';
  ...
  if (view.screen === 'daywork') {
    ...
    const detail = (
      <DayworkDetail
        ...
        onAddWorkerLogs={(taskId, logs) => addWorkerLogs(project.id, dw.id, taskId, logs)}
